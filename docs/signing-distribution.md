...
```text
Identifier=app.windowcycle.WindowCycle
Authority=WindowCycle Local Code Signing
designated => identifier "app.windowcycle.WindowCycle" and certificate leaf = H"..."
```
...
- users build locally
- optional experimental self-signed DMG generated by `Scripts/build-dmg.sh`
...
- optionally ship the experimental, not-notarized DMG for advanced users
